...
$selectQuery = "SELECT * FROM JavaChat WHERE MessageID = :messageID AND UserID = :loggedInUserID";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['updateMessage'])) {
    ...
    $updateQuery = "UPDATE JavaChat SET Content = :editedContent WHERE MessageID = :messageID AND UserID = :loggedInUserID";
    ...
    header('Location: java_chat.php'); // Redirect back to the chatroom after updating
    exit();
}
?>
