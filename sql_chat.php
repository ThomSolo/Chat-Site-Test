...
<head>
    ...
    <title>SQL Chat Room - <?php echo $loggedInUsername; ?></title> <!-- For displaying the user's username by the Title --> 
</head>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <h1>SQL Chat Room - <?php echo $loggedInUsername; ?></h1> <!-- Shows the User's username on the header of the page by "Chat Room" -->
</header>
