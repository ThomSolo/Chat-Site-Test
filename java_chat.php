...
/*Notes
This is a public chat room for (Java).
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['sendMessage'])) { // Checks if the form is submitted and the send message button is clicked
    ...
    $insertQuery = "INSERT INTO JavaChat (UserID, Content, IsPrivate) VALUES (:userID, :content, :isPrivate)";
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.min.js"></script>
    ...
    <title>Java Chat Room - <?php echo $loggedInUsername; ?></title> <!-- For displaying the user's username by the Title --> 
</head>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <h1>Java Chat Room - <?php echo $loggedInUsername; ?></h1> <!-- Shows the User's username on the header of the page by "Chat Room" -->
</header>
    ...
    <div class="chat-box">
        ...
        foreach ($messages as $message) { // Iterates through each message
            ...
            if (isset($message['UserID']) && $message['UserID'] == $loggedInUserID) { // Checks if the message is from the logged-in user
                ...
                echo " <a href='java_edit_mes.php?messageID={$message['MessageID']}'>Edit</a>"; // Links to "java_edit_mes.php", it edits messages.
                echo " <a href='java_delete_mes.php?messageID={$message['MessageID']}'>Delete</a>"; // Links to "java_delete_mes.php", it deletes messages.
            }
